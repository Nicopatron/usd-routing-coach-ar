...
- **AFIP no audita por sospecha; audita por inconsistencia.** Si tu invoice metadata matchea con tus inflows declarados, sos invisible. Si no, el cross-check ARCA (RG 3421 + sub-régimen SITER por RG 4298 + reportes VASP) te encuentra en 6-12 meses. Los patterns concretos viven en [`reference/afip-audit-signals.md`](./reference/afip-audit-signals.md).
