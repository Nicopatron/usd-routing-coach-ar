...
- **Monotributo** — Argentine simplified tax regime for small contributors (self-employed, freelancers). Single monthly fee covers income tax, social security, and healthcare. Cats A-K with annual billing limits as of February 2026 recategorización. Cap: cat K ARS ceiling 108.357.084 — operational USD equiv. ~$76,415 at MEP 1.418, ~$77,675 at BCRA oficial ~1.395 (see `monotributo-categorias.md` for the rate-anchor caveat: AFIP cat-math uses BCRA oficial cotización of Factura E day, not MEP). Above cat K → forced transition to RI.
...
- **VASP (Virtual Asset Service Provider)** — CNV-regulated crypto platform. Mandatory registration since May 2025. Examples: Lemon, Belo, Buenbit, Bitso, Ripio, Binance Argentina. Required for any compliant USDT routing.
- **Lemon, Belo, Buenbit, Bitso, Ripio, Binance Argentina** — CNV-registered VASPs as of May 2026. The specialist treats these as compliant USDT lanes. Registration numbers verificados mayo 2026 vía CNV + secondary corroboration: Ripio (operador legal Moonbird SRL) inscripto bajo N° 36 (5-jun-2024); Bitso inscripto bajo N° 51 (19-jul-2024). Other unlisted exchanges may not be CNV-registered. Verificá la lista actual en https://www.cnv.gov.ar/SitioWeb/ProveedoresServiciosActivosVirtuales/RegistrosPSAV antes de cualquier decisión de lane USDT.
